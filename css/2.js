...
(function (f) {
    ...
    function Ga(a) {
        ...
        if (a) {
            ...
            !a.sEmptyTable && d && "За Вашим запитом нічого не знайдено" === b.sEmptyTable && M(a, a, "sZeroRecords", "sEmptyTable");
    ...
    q.defaults = {
        ...
        iStateDuration: 7200,
        iDeferLoading: null,
        /*к-во строк отобразить в картотеке*/
        iDisplayLength: 20,
        iDisplayStart: 0,
        iTabIndex: 0,
        oClasses: {},
        oLanguage: {
            ...
            oPaginate: {
                ...
                sNext: "<i class='fas fa-caret-right'></i>", sPrevious: "<i class='fas fa-caret-left'></i>"
            },
            sEmptyTable: "За Вашим запитом нічого не знайдено",
            sInfo: "відображено карток [_START_ ... _END_] із _TOTAL_ ",
            sInfoEmpty:'',
            //sInfoEmpty: "відображено карток [0 ... 0] із 0",
