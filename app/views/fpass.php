...
border: 1px solid #122b40; padding: 10px;box-sizing: border-box;">
    ...
    width: 120px;text-align: left;color: #818181;">Введіть Ваш E-mail: </label></td>
                        ...
                        <tr>
                            <td> <label style="font-size: 12px;display: block;
    width: 120px;text-align: left;color: #818181;">Введіть капчу: </label></td>
                            <td>

                                <div style="width: 250px;" class="g-recaptcha" data-sitekey="6Lel6ekUAAAAAHpdj6caj0Wa2S5pDWJqph87Zqnh"></div>
                            </td>
                        </tr>
                        <tr>
