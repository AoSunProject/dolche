...
/********************/
    ...
    private static $_version = "php_1.0";
        /**********************/
    public function newvizit($id_k,$nomPac){
        //echo $nomPac;die();
        $date=date('y.m.d');
        $idLast=DatabaseModule::instance()->karta->insertvizit($id_k,$nomPac);

return $idLast;

    }
    public function getmaxv($nomPac){
        $s="Select max(nomV) from karta where nomPac={$nomPac}";
        $id=DatabaseModule::instance()->karta->query($s);

        $id=$id[0]['max(nomV)']+1;
        return $id;
    }
    public function addvizit($name,$fname,
        ...
        ,$datB,$city,$rajon,
                             ...
                             $phone,$email,$vagaPN,$gen,$systisk,$atgad,$atgaddat,$dieta,$disttisk,$nomV,$datV,$statysA,$vlasnik,$pomer,$nomPac){
       // echo $nomPac;die();
        $date=date('y.m.d');
        ...
        $idLast=DatabaseModule::instance()->karta->insert1(
            [
                "name" => $name,
                "fname" => $fname,
                "sname" => $sname,
...
$phone,$email,$vagaPN,$gen,$systisk,$atgad,$atgaddat,$dieta,$disttisk,$nomV,$datV,$statysA,$vlasnik,$pomer){
        ...
        DatabaseModule::instance()->karta->updateWhere1(
            [
                "nomPac" => $idLast
              ],"id={$idLast}");
    }
    public function save($id,$name,$fname,
        ...
        ,$datB,$city,$rajon,
                         ...
                         $dateOnko,$OnkoLek,$hronSerd,$bearn,$vesR,$art1,$datStad,$diabAngin,$datAngin,$kakAngio,$diabNejr,$datNejr,
                         $diabStopp,$Bol,$Boltwo,$BolInten,$Bolkak,$Preparat,$PreparatKakie,$datStopObsl,$SnizhT,$golodSem,$datPochNEd,$arr,
$phone,$email,$vagaPN,$gen,$systisk,$atgad,$atgaddat,$dieta,$disttisk,$nomV,$datV,$statysA,$vlasnik,$pomer,$nomPac,$datedeth,$sincdeth){
